  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400, padding: '0 24px', boxSizing: 'border-box' }}>
        <h2 style={{ textAlign: 'center', marginBottom: 24 }}>Activity Logger</h2>
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: 'block', textAlign: 'left', fontSize: 14, marginBottom: 0 }}>
              メールアドレス
              <input
                type="email"
                name="email"
        ...
        <div style={{ textAlign: 'center' }}>
          <button onClick={() => setIsSignUp(!isSignUp)} style={{ marginTop: 12, background: 'none', border: 'none', cursor: 'pointer', color: '#99c2ff', fontSize: 14 }}>
